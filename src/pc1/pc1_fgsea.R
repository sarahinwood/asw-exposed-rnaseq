...
res_group <- fread("output/deseq2/asw/pc1/no_count_filtering/good_res_group.csv")
...
##change long label to shorter
annot_sig_fgsea <- fread("output/deseq2/asw/pc1/plot_sig_GO_enrichment.csv")
