...
res_group <- fread("output/deseq2/asw/interaction/exposure_invermay/res_group.csv")
...
fwrite(annot_sig_fgsea, "output/deseq2/asw/interaction/exposure_invermay/sig_GO_enrichment.csv")
...
term_res <- annot_sig_fgsea[annot_sig_fgsea$pathway == "GO:0006281",]
...
fwrite(term_leading_edge_annots, "output/deseq2/asw/interaction/exposure_invermay/DNArepair_leading_edge_annots.csv")
