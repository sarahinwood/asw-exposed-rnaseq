...
res_group <- fread("output/deseq2/asw/interaction/location_exposure/res_group.csv")
...
fwrite(annot_sig_fgsea, "output/deseq2/asw/interaction/location_exposure/sig_GO_enrichment.csv")
