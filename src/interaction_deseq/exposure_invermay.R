...
fwrite(all_annots, "output/deseq2/asw/interaction/exposure_invermay/all_sig_annots.csv")
...
#####################################
sig_30 <- fread("output/deseq2/asw/interaction_30/exposure_invermay/all_sig_annots.csv")
