...
asw_dds_int <- readRDS("output/deseq2/asw/location_location_exposed_pc1_int/dds_interaction.rds")
...
plotCounts(asw_dds_int, "TRINITY_DN9682_c0_g1", intgroup = c("location", "treatment"))
