...
res_group_interaction <- results(asw_dds_int, alpha=0.05, lfcThreshold = 1, name="locationRuakura.treatmentExposed")
...
plotCounts(asw_dds_int, "TRINITY_DN17183_c0_g2", intgroup = c("location", "treatment"))
