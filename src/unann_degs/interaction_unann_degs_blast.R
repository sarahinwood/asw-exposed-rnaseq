...
unann_degs_blast <- fread("output/deseq2/asw/unann_degs/interaction_nr_blastx.outfmt6")
...
blast_res$rn <- tstrsplit(blast_res$transcript_id, "_i", keep=1)
fwrite(blast_res, "output/deseq2/asw/unann_degs/interaction_blastx_unann_res.csv")
